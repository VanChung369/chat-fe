...
export function PreferencesHero({ eyebrow, title, description }: PreferencesHeroProps) {
  return (
    <header>
      <div className="mb-4 inline-flex items-center gap-3 rounded-full border border-indigo-500/20 bg-indigo-500/8 px-4 py-2 text-xs font-bold tracking-[0.22em] text-indigo-300 uppercase">
